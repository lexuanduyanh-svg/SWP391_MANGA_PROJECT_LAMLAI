...
public class AnnotationEntity {
  ...
  @Column(name="spatial_coordinates") private String spatialCoordinates; @Column(columnDefinition = "text") private String content; private Boolean resolved; @Column(name="created_at") private LocalDateTime createdAt;
