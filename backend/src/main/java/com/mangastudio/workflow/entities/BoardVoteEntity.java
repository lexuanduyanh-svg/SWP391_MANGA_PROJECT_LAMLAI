...
public class BoardVoteEntity {
  @Id @GeneratedValue(strategy=GenerationType.IDENTITY) @Column(name="vote_id") private Long id;
  @ManyToOne @JoinColumn(name="series_id") private SeriesEntity series; @ManyToOne @JoinColumn(name="board_member_id") private UserEntity boardMember; private String decision; @Column(name="created_at") private LocalDateTime createdAt;
